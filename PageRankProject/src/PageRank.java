...
public class PageRank {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Triggering Phase1 - Initial Rank calculation");
        ...
        for (int runs = 0; runs < iterations; runs++) {
            ...
            System.out.println("############# Running Phase2 for "+(runs + 1)+" "+ iterations +" - New PageRank caluclations");
        ...
        System.out.println(" ################Running Phase3 ---- final rank ordering Phase ");
    ...
    public boolean phase2(String in, String out) throws IOException, 
        ...
        Job job = Job.getInstance(new Configuration(), "Phase2");
        job.setJarByClass(PageRank.class);
    ...
    public boolean phase3(String in, String out) throws IOException, 
        ...
        Job job = Job.getInstance(new Configuration(), "Phase3");
        job.setJarByClass(PageRank.class);
